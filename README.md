...
- [x] `ERC20-to-Native` Currently in development. Pre-existing tokens in the Foreign network are locked and coins are minted in the `Home` network. The Home network consensus engine in this case should support invocation of Parity's Block Reward contract (https://wiki.parity.io/Block-Reward-Contract.html) to mint coins per the bridge contract request.
- [x] `ERC20-to-ERC20-multiple` TODO
...
| `HOME_BRIDGE_MAPPER_ADDRESS`          	| TODO                                                                                                                                                                                                                                                                                                                                                                                                 	| hexidecimal beginning with "0x"                                          	| **Only** for `ERC_TO_ERC_MULTIPLE`                                               	|
| `HOME_BRIDGE_MAPPER_POLLING_INTERVAL` 	| TODO                                                                                                                                                                                                                                                                                                                                                                                                 	| integer                                                                  	| **Only** for `ERC_TO_ERC_MULTIPLE`                                               	|
